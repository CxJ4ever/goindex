...
<div class="mdui-container-fluid">
	...
	<video class="mdui-video-fluid mdui-center" preload controls>
	  ...
	  <track src="${url}.vtt" srclang="en" label="English" kind="subtitles" default />
	  <track src="${url}.zh.vtt" srclang="zh" label="Chinese" kind="subtitles" default />
	  <track src="${url}.en-zh.vtt" srclang="en-zh" label="Ch-En" kind="subtitles" default />
	</video>
	<br>
	<!-- 固定标签 -->
	<div class="mdui-textfield">
